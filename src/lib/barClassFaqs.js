// Single source of truth for the /bar-class FAQ — read by both the visible
// Accordion (components/bar-class/FAQ.js) and its FAQPage structured data
// (components/bar-class/FAQStructuredData.js).
export const barClassFaqs = [
  ...
  },
  {
    ...
    a: "Every Thursday at 3:00 PM.",
  },
  {
    q: "How much does the Bar Class cost?",
    a: "IDR 250,000 per person, with a minimum of 2 guests.",
  },
  {
    q: "Can I also watch the Balinese Dance on the same day?",
