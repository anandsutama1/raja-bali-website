...
// proxy.js deliberately never writes this itself, only reads it, so a guest
// who never manually picked a language gets fresh Accept-Language detection
// on every bare-root visit (their phone's language setting is followed
// live), while a guest who DID pick manually has that choice remembered and
