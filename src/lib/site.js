...
export const LOCATIONS = [
  {
    ...
    // Same embeddable iframe src already used on /outlets
    // (components/outlets/Location.js) — kept here too so any other page
    // needing an inline map for this location (e.g. cooking-class/bar-class,
    // both held here) reads it from one place instead of a second copy of
    // this long pb= string.
    mapEmbedSrc:
