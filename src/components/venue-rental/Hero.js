...
export default function VenueRentalHero({ content }) {
  return (
    <section className="relative h-[50vh] bg-raja-black flex flex-col items-center justify-center text-center text-white px-6">
      <SmartImage src="/images/venue-rental/Hero.jpg" alt="Raja Bali's garden and private room, available for venue rental" priority sizes="100vw" />
