...
const locations = [
  {
    // Matches this location's actual registered Google Maps name, visible
    // in the embed URL below ("Raja Bali Nusa Dua (Main Restaurant)").
    title: "Raja Bali Nusa Dua (Main Restaurant)",
    mapSrc:
  ...
  {
    title: "Raja Bali Nusa Dua (Dine-in Restaurant)",
    mapSrc:
    ...
    Tripadvisor: TripadvisorBadgeNusaDua,
  },
];
