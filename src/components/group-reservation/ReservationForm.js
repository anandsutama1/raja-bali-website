    ...
    <section id="reservation" className="border-t border-gray-200 py-20 px-6 max-w-2xl mx-auto bg-white">
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-raja-black text-white px-6 py-3 rounded w-full hover:bg-raja-red transition disabled:cursor-not-allowed disabled:opacity-60"
        >
          {status === "submitting" && (
            <span
              aria-hidden="true"
