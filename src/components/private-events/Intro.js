  ...
  return (
    <section className="max-w-3xl mx-auto text-center border-t border-gray-200 py-24 px-6 bg-white">
      ...
      <p className="text-gray-600 leading-relaxed mb-10">
        From birthday celebrations and corporate dinners to family reunions, anniversaries, and wedding receptions, Raja Bali provides a beautiful setting where authentic Balinese hospitality meets exceptional cuisine.
      </p>
