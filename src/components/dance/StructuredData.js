...
export default function DanceStructuredData() {
  ...
  const jsonLd = {
    ...
    description:
      "A complimentary Balinese dance performance for dining guests, held every Thursday evening at Raja Bali Main Restaurant in Nusa Dua's Tanjung Benoa area, featuring live music, traditional costumes, and a rotating repertoire of sacred stories.",
