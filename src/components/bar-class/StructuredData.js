...
export default function BarClassStructuredData() {
  ...
  const description =
    "Hands-on Balinese cocktail class at Raja Bali in Nusa Dua's Tanjung Benoa area. Learn mixology from expert bartenders, taste authentic Balinese Arak, and craft your own signature drink. Thursdays only, followed by a complimentary Balinese dance performance the same evening, free for dining guests.";
