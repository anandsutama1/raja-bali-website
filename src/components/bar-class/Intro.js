  ...
  return (
    <section className="max-w-3xl mx-auto text-center border-t border-gray-200 py-24 px-6 bg-white">
      ...
      <p className="text-gray-600 leading-relaxed mb-10">
        This cocktail-making class is your chance to discover the creativity, craftsmanship, and tropical flavors behind Bali's vibrant bar culture. Learn the stories behind local ingredients in a fun, interactive session suited to beginners and cocktail enthusiasts alike.
      </p>
