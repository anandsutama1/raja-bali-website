 ...
 * renders the same `mainRestaurantFaqs` array visibly directly above
...
export default function FAQStructuredData() {
  const jsonLd = {
    ...
    "@type": "FAQPage",
    mainEntity: mainRestaurantFaqs.map((faq) => ({
      "@type": "Question",
      name: faq.q,
      acceptedAnswer: {
        "@type": "Answer",
  ...
  return (
    <script
      ...
      // Data is our own static config (src/lib/mainRestaurantFaqs.js), not user input.
