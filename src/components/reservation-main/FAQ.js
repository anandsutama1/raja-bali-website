...
// spliced into the answer (e.g. "Visit our Cooking Class page to book")
// while FAQStructuredData reads the plain-text concatenation of the same
// fields — same words either way, just a hyperlink on top.
